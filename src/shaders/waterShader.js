...
const defaultUniforms = {
  ...
  // Wave parameters
  uWavesAmplitude: { value: 0.001 },
  uWavesSpeed: { value: 0.45 },
  uWavesFrequency: { value: 0.16 },
  uWavesPersistence: { value: 0.16 },
  uWavesLacunarity: { value: 0.0 },
  ...
  // Fresnel parameters
  uFresnelScale: { value: 1.7 },
  uFresnelPower: { value: 1.7 },

  // Environment map (needs to be set by the user)
  uEnvironmentMap: { value: null }
};

export { vertexShader, fragmentShader, defaultUniforms };